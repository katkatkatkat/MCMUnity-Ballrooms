...
public class LevelVideoLoader : MonoBehaviour, IGvrGazeResponder {

	//public string changeAble;
	// Is player looking at me?
	public string Level = "Video02";
	...
	public void LoadLevel(string sceneToLoad){
		...
		StartCoroutine(GameController360fly.control.LoadLevel(sceneToLoad));
	}
